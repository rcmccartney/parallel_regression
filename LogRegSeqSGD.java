 ...
 *
 */
public class LogRegSeqSGD extends Task {

	// Program shared variables.
	// Command line arguments.
	private static String test, separator;
	private static int classIdx, snap, records, converge;
	private static double eps, alpha, threshold, testPercent;
		...
		for(;;) {
			...
			*/
			...
			for(int j=0; j < weights.length; j++)
				weights[j] -= alpha*weightUpdate[j];
